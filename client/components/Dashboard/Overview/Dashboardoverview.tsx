  ...
  return (
    <section className="flex flex-col gap-4">
      ...
      <div className="flex sm:flex-row flex-col gap-4">
        <div className="bg-white dark:bg-transparent dark:text-white rounded-lg h-[500px] dark:p-0 p-4 w-full">
          <div>
            <DashboardHeader
        ...
        <div className="bg-white  dark:bg-transparent dark:text-white rounded-lg sm:h-[500px] dark:p-0 h-[550px] p-4 w-full">
          <div>
            <DashboardHeader
