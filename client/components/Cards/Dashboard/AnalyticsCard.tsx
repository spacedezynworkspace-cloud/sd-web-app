  ...
  return (
    <div className='bg-white dark:bg-orange-100 rounded-lg shadow p-4'>
            <div className='flex items-center mb-2'>
               <div className='w-10 h-10 rounded-lg flex items-center justify-center p-2 bg-orange-200/50'>
                 {data.icon}
               </div>
               <div>
                <h2 className='text-lg font-semibold ml-2 text-gray-800'>{data.value}</h2>
                <div>
