...
const VRBanner = () => {
  return (
    <section className="flex items-center bg-white dark:bg-black sm:py-14 px-4 sm:px-0 py-5">
      <div className="bg-[#F19645] sm:h-[30rem] sm:flex-row gap-10 flex-col-reverse flex items-end shadow-2xl rounded-lg max-w-7xl px-4 pt-4 sm:px-6 lg:px-8 mx-auto">
        <div>
          <Image
            src={
